...
pub fn revrdx6(
    ...
    assert_eq!(nv, a.len());
    assert_eq!(lv, a[0].len());
    assert_eq!(6, a[0][0].len());

    assert_eq!(nv, b.len());
    assert_eq!(6, b[0].len());
    assert_eq!(lv, b[0][0].len());
...
mod test {
    use {
        crate::{stafft::*, utils::slice_to_3d},
    ...
    fn revrdx2_simple_1() {
        ...
        revrdx2(&a, &mut b, nv, lv, &cosine, &sine);
