...
pub fn criterion_benchmark(c: &mut Criterion) {
    let mut group = c.benchmark_group("nhswps");
    ...
    group.bench_function("source", |b| {
        let state = {
            ...
            let aa = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_aa.bin");
            let qs = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_qs.bin");
            let ds = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_ds.bin");
            let ps = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_ps.bin");
            let u = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_u.bin");
            let v = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_v.bin");
            let ri = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_ri.bin");
            let dpn =
                array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_dpn.bin");
            let z = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_z.bin");
            let zx = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_zx.bin");
            let zy = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/source/32_4_zy.bin");
    ...
    group.bench_function("vertical", |b| {
        let mut state = {
            ...
            let z = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/vertical/32_4_z.bin");
            ...
            let r = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/vertical/32_4_r.bin");
            let w = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/vertical/32_4_w.bin");
            ...
            let u = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/vertical/32_4_u.bin");
            let v = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/vertical/32_4_v.bin");
    ...
    group.bench_function("coeffs", |b| {
        let ng = 32;
        let nz = 4;

        let state = {
            let ri = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/coeffs/32_4_ri.bin");
            let zx = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/coeffs/32_4_zx.bin");
            let zy = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/coeffs/32_4_zy.bin");
    ...
    group.bench_function("cpsource", |b| {
        let state = {
            let ng = 32;
            let nz = 4;
            ...
            let u = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/cpsource/32_4_u.bin");
            let v = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/cpsource/32_4_v.bin");
            let w = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/cpsource/32_4_w.bin");
            let z = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/cpsource/32_4_z.bin");
    ...
    group.bench_function("psolve", |b| {
        let mut state = {
            let ng = 32;
            let nz = 4;

            let ri = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_ri.bin");
            let r = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_r.bin");
            let u = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_u.bin");
            let v = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_v.bin");
            let w = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_w.bin");
            let z = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_z.bin");
            let zeta = array3_from_file!(
                ng,
                ng,
                nz + 1,
            ...
            let zx = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_zx.bin");
            let zy = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_zy.bin");
            let ps = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_ps.bin");
            let pn = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_pn.bin");
            let dpn =
                array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_dpn.bin");
            let aa = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_aa.bin");
            let qs = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_qs.bin");
            let ds = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_ds.bin");
            let gs = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/psolve/32_4_gs.bin");
    ...
    group.bench_function("advance", |b| {
        let mut state = {
            ...
            let r = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/advance/24_4/r.bin");
            let u = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/advance/24_4/u.bin");
            let v = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/advance/24_4/v.bin");
            let w = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/advance/24_4/w.bin");
            let z = array3_from_file!(ng, ng, nz + 1, "../src/nhswps/testdata/advance/24_4/z.bin");
            let zeta = array3_from_file!(
                ng,
                ng,
                nz + 1,
    ...
    group.bench_function("advance_128", |b| {
        let mut state = {
            let ng = 128;
            let nz = 16;
    ...
    group.bench_function("savegrid", |b| {
        let mut state: State =
